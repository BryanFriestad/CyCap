...
public class ClientInputHandler {
	...
	public ClientInputHandler(String client_id, String input_passcode) {
		...
		input_mapping.put(InputAction.MOVE_UP, 49);
		input_mapping.put(InputAction.MOVE_DOWN, 49);
		input_mapping.put(InputAction.MOVE_LEFT, 49);
		input_mapping.put(InputAction.MOVE_RIGHT, 49);
		input_mapping.put(InputAction.SHOOT, 49);
		input_mapping.put(InputAction.RELOAD, 82);
		input_mapping.put(InputAction.USE_ITEM, 70);
		input_mapping.put(InputAction.ZOOM, 49);
		previous_snapshot = null;
		current_snapshot = null;
		highest_snapshot_number = 0;
		keys_down = new ArrayList<Integer>();
