...
public class AnimatedDrawable extends Drawable {
	 ...
	 */
	public AnimatedDrawable(Image image, int startingSpriteIndex, Position drawPosition, double drawHeight, double drawWidth, double rot, double a, int animation_frames, long ani_len, boolean do_loop, boolean show_while_paused) {
		super(image, startingSpriteIndex, drawPosition, drawHeight, drawWidth, rot, a);
	 ...
	 * @param ani_len
	 */
	public AnimatedDrawable(Image image, Position drawPosition, double drawHeight, double drawWidth, int animation_frames, long ani_len) {
		super(image, 0, drawPosition, drawHeight, drawWidth);
		if(animation_frames < 1){
			throw new IllegalArgumentException("animation_frames(" + animation_frames + ") must be greater than 0");
		}
	 ...
	 * @param ani_len
	 */
	public AnimatedDrawable(Image image, Position drawPosition, long ani_len) {
		super(image, 0, drawPosition);
		if(ani_len < 0){
			throw new IllegalArgumentException("ani_len(" + ani_len + ") must be positive or 0");
		}
		this.start_sprite_index = 0;
