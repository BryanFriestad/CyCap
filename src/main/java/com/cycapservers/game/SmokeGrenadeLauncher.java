...
public class SmokeGrenadeLauncher extends ThrownWeapon {
	...
	public SmokeGrenadeLauncher(String name, int damage, int bt, int rate, int mag_size, int extra_mags, int reload_time, double max_height, int lifeTime, int range, int smoke_time, int intensity) {
	...
	public SmokeGrenadeLauncher(SmokeGrenadeLauncher g) {
		super(g);
