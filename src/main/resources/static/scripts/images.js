...
player_images.src = BASE_DIR + "res/images/player_images.png";
generateSpriteSheetData(128, 128, 4, 2, player_images);

let enemy_image = new Image();
enemy_image.src = BASE_DIR + "res/images/enemy.png";
enemy_image.sprites = [{x:0, y:0, h:128, w:128}];

let bullet_image = new Image();
bullet_image.src = BASE_DIR + "res/images/bullets.png";
...
background_tiles.src = BASE_DIR + "res/images/map_tiles_ss.png";
...
wall_image.src = BASE_DIR + "res/images/wall2.png";
wall_image.sprites = [{x:0, y:0, w:64, h:64}];

let blast1_image = new Image();
blast1_image.src = BASE_DIR + "res/images/blast1.png";
blast1_image.sprites = [{x:0, y:0, w:128, h:128}];

//////POWER UPS//////
let speed_potion_ss = new Image();
speed_potion_ss.src = BASE_DIR + "res/images/speed_potion.png";
...
smoke_ss.src = BASE_DIR + "res/images/smoke_cloud.png";
smoke_ss.sprites = [{x:0, y:0, h:256, w:256}];
				   
let flags_ss = new Image();
flags_ss.src = BASE_DIR + "res/images/flags.png";
